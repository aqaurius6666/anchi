const data = [
  ...
  },
  {
    ...
    description: 'Dookki Việt Nam như phát súng nổ cho sự kết hợp giữa buffet và lẩu topokki, thay vì chỉ phục vụ kinh doanh các món tokbokki riêng lẻ. Tạo nên xu thế mới trong phong cách thưởng thức món Hàn dành cho giới trẻ Việt Nam.',
    menu: [
      'bánh gạo',
    ],
    note: {
  ...
  },
  {
    ...
    description: 'Được thành lập từ năm 1994, Haidilao là chính là một minh chứng sống cho sự kiên trì, bền bỉ để dẫn đến thành công của chủ thương hiệu này. Ban đầu đây chỉ là một cửa hàng nhỏ, trải qua nhiều thăng trầm đã trở thành một thương hiệu lớn độc nhất và thuộc top các quán lẩu ngon ở Hà Nội gây sốt cộng động ẩm thực.',
    menu: [
      'lẩu cay',
      'lẩu cà chua',
      'lẩu chua cay',
  ...
  },
  {
    ...
    description: 'The Pizza Company là một chuỗi nhà hàng và nhượng quyền quốc tế có trụ sở tại Bangkok, Thái Lan.',
    menu: [
      'Pizza Phượng Hoàng',
